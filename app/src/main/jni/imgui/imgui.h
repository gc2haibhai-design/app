...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChild(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
        ...
        IMGUI_API bool          MenuChild( const char* str_id, const ImVec2& size = ImVec2( 0, 0 ), bool border = false, ImGuiWindowFlags flags = 0 );
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
       IMGUI_API bool          TabSubTab_Subtab(const char* name, bool boolean);
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v);
        IMGUI_API bool          𝙆𝘼𝙐𝙎𝙃𝙄𝙆(const char* label, bool* v);
            IMGUI_API bool          𝙆𝘼𝙐𝙎𝙃𝙄𝙆_𝙉𝙀𝙒(const char* label, bool* v);
    ...
    IMGUI_API void          EndTabItem();                                                       // only call EndTabItem() if BeginTabItem() returns true!
       IMGUI_API bool          Kaushik_Subtab(const char* name, bool boolean);
...
namespace Colors {
	...
	inline ImVec4 TextNew;
    inline ImVec4 TextDisabledNew;
    inline ImVec4 TextActiveNew;
}
