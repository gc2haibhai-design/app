...
namespace ImGui
{
   ...
   IMGUI_API bool          OptButtonEx3(const char* ico, const ImVec2& size_arg = ImVec2(0, 0), bool rotation = false, ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          SliderBehavior(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, void* p_v, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags, ImRect* out_grab_bb, float* percent);
    ...
    template<typename T, typename SIGNED_T, typename FLOAT_T>   IMGUI_API bool  SliderBehaviorT(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, T* v, T v_min, T v_max, const char* format, ImGuiSliderFlags flags, ImRect* out_grab_bb, float* percent );
