...
struct FMovieSceneAudioSectionTemplateData
{
	...
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0110(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0110(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
