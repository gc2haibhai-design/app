...
// Telegram:- @Manish8x
// GEN ONThu Mar 19 07:20:43 2026
...
struct FKAggregateGeom
{
	...
	TArray<TEnumAsByte<enum EShapeUsage>>              SphereUsages;                                             // 0x0010(0x0010) (Edit, ZeroConstructor)
	...
	TArray<TEnumAsByte<enum EShapeUsage>>              BoxUsages;                                                // 0x0040(0x0010) (Edit, ZeroConstructor)
	...
	TArray<TEnumAsByte<enum EShapeUsage>>              SphylUsages;                                              // 0x0070(0x0010) (Edit, ZeroConstructor)
	...
	TArray<TEnumAsByte<enum EShapeUsage>>              ConvexUsages;                                             // 0x00A0(0x0010) (Edit, ZeroConstructor)
...
{
	TEnumAsByte<enum EShapeUsage>                      ShapeUsage;                                               // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET
	struct FName                                       Name;                                                     // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0010(0x0008) MISSED OFFSET
};
...
struct FTimeline
{
	...
	struct FScriptDelegate                             TimelinePostUpdateFunc;                                   // 0x0058(0x000C) (ZeroConstructor, InstancedReference, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0058(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             TimelineFinishedFunc;                                     // 0x0068(0x000C) (ZeroConstructor, InstancedReference, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0068(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData05[0x10];                                      // 0x0078(0x0010) MISSED OFFSET
